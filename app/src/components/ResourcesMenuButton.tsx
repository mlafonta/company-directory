                                ...
                                <ClickAwayListener onClickAway={handleClose}>
                                    ...
                                    >
                                        {categories.map((header) => (
                                            <div key={header}>
                                                <ListSubheader className="resource-menu-header" key={header}
                                                               color='inherit'>{header}</ListSubheader>
                                                <li>
                                                    {resources.filter(item => item.category == header).map(filteredItem => (
                                                        <MenuItem className="team-menu-text" key={filteredItem.id}
                                                                  component="a" href={filteredItem.url}
                                                                  target="_blank">{filteredItem.name}</MenuItem>
                                                    ))}
                                                </li>
                                            </div>
                                        ))}
